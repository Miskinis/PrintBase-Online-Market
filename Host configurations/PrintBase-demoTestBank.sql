...
INSERT INTO `accounts` VALUES (0,'Eimantas','Klimavicius',1111222233334444,'12/30',555,1000),(1,'Vardenis','Pavardenis',2222333344445555,'11/21',666,50),(2,'Ponas','Jonas',3333444455556666,'10/22',777,300);
...
CREATE TABLE `buyer` (
  ...
  `cardIdentity` decimal(4,0) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`,`component_id`,`buyer_id`),
  KEY `fk_cart_component1_idx` (`component_id`),
  KEY `fk_orders_buyer1_idx` (`buyer_id`),
  CONSTRAINT `fk_cart_component1` FOREIGN KEY (`component_id`) REFERENCES `component` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_buyer1` FOREIGN KEY (`buyer_id`) REFERENCES `buyer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-12  1:16:49
